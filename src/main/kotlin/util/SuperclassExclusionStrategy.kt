...
import com.stirante.lolclient.libs.com.google.gson.ExclusionStrategy
import com.stirante.lolclient.libs.com.google.gson.FieldAttributes
...
class SuperclassExclusionStrategy : ExclusionStrategy {
    ...
    override fun shouldSkipField(fieldAttributes: FieldAttributes): Boolean {
        val fieldName: String = fieldAttributes.name
        val theClass: Class<*> = fieldAttributes.declaringClass
