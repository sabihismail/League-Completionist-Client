...
data class GameData(
    ...
    fun getCurrentChampionId(summonerId: Long): Int {
        val nameToChampionIdMapping = (teamOne + teamTwo).associate { it.summonerId to it.championId }

        return nameToChampionIdMapping[summonerId]!!
    }
}
